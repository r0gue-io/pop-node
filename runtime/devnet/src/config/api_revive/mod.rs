...
pub(crate) use pallet_api_revive::Extension;
use pallet_api_revive::{extension::*, Read};
use sp_core::ConstU8;
...
use crate::{
	config::assets::TrustBackedAssetsInstance, fungibles_revive as fungibles, Runtime, RuntimeCall,
	RuntimeEvent,
};
...
type DecodesAs<Output, Logger = ()> = pallet_api_revive::extension::DecodesAs<
	Output,
...
#[derive(Default)]
pub struct Config;
impl pallet_api_revive::extension::Config for Config {
...
mod tests {
	use codec::Encode;
	use pallet_api_revive::fungibles::Call::*;
