...
pub trait Psp22 {
	...
	///
	/// The selector is `0x162df8c2` (first 4 bytes of `blake2b_256("PSP22::total_supply")`).
	///
	/// # Reference
	/// https://github.com/w3f/PSPs/blob/master/PSPs/psp-22.md#total_supply--balance
	#[ink(function = 0x162df8c2)]
	fn total_supply(&self) -> Balance;

	/// Returns the account balance for the specified `owner`.
	///
	/// The selector is `0x6568382f` (first 4 bytes of `blake2b_256("PSP22::balance_of")`).
	///
	/// # Parameters
	...
	#[ink(function = 0x6568382f)]
	fn balance_of(&self, owner: AccountId) -> Balance;

	/// Returns the allowance for a `spender` approved by an `owner`.
	///
	/// The selector is `0x4d47d921` (first 4 bytes of `blake2b_256("PSP22::allowance")`).
	///
	/// # Parameters
	...
	#[ink(function = 0x4d47d921)]
	fn allowance(&self, owner: AccountId, spender: AccountId) -> Balance;

	/// Transfers `value` amount of tokens from the caller's account to account `to`
	/// with additional `data` in unspecified format.
	///
	/// The selector is `0xdb20f9f5` (first 4 bytes of `blake2b_256("PSP22::transfer")`).
	///
	/// # Parameters
	...
	#[ink(function = 0xdb20f9f5)]
	fn transfer(&mut self, to: AccountId, value: Balance, data: Vec<u8>) -> Result<(), PSP22Error>;

	/// Transfers `value` tokens on behalf of `from` to the account `to`
	/// with additional `data` in unspecified format.
	///
	/// The selector is `0x54b3c76e` (first 4 bytes of `blake2b_256("PSP22::transfer_from")`).
	///
	/// # Parameters
	...
	///
	/// The selector is `0xb20f1bbd` (first 4 bytes of `blake2b_256("PSP22::approve")`).
	///
	...
	#[ink(function = 0xb20f1bbd)]
	fn approve(&mut self, spender: AccountId, value: Balance) -> Result<(), PSP22Error>;

	/// Increases the allowance of `spender` by `value` amount of tokens.
	///
	/// The selector is `0x96d6b57a` (first 4 bytes of `blake2b_256("PSP22::increase_allowance")`).
	///
	/// # Parameters
	/// - `spender` - The account that is allowed to spend the tokens.
	...
	///
	/// The selector is `0xfecb57d5` (first 4 bytes of `blake2b_256("PSP22::decrease_allowance")`).
	///
	/// # Parameters
	/// - `spender` - The account that is allowed to spend the tokens.
...
pub trait Psp22Metadata {
	...
	///
	/// The selector is `0x3d261bd4` (first 4 bytes of `blake2b_256("PSP22Metadata::token_name")`).
	///
	/// # Reference
	/// https://github.com/w3f/PSPs/blob/master/PSPs/psp-22.md#token_name--option
	#[ink(function = 0x3d261bd4)]
	...
	#[ink(function = 0x34205be5)]
	fn token_symbol(&self) -> Option<String>;

	/// Returns the token decimals.
	///
	/// The selector is `0x7271b782` (first 4 bytes of `blake2b_256("PSP22Metadata::token_decimals")`).
	///
	/// # Reference
	/// https://github.com/w3f/PSPs/blob/master/PSPs/psp-22.md#token_decimals--u8
	#[ink(function = 0x7271b782)]
...
pub trait Psp22Mintable {
	...
	///
	/// The selector is `0xfc3c75d4` (first 4 bytes of `blake2b_256("PSP22Mintable::mint")`).
	///
	/// # Parameters
...
pub trait Psp22Burnable {
	...
	///
	/// The selector is `0x7a9da510` (first 4 bytes of `blake2b_256("PSP22Burnable::burn")`).
	///
	/// # Parameters
