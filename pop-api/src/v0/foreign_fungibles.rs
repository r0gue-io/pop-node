...
const TRANSFER: u8 = 3;
const FOREIGN_FUNGIBLES: u8 = 152;
...
fn build_dispatch(dispatchable: u8) -> ChainExtensionMethodApi {
	crate::v0::build_dispatch(FOREIGN_FUNGIBLES, dispatchable)
}
...
fn build_read_state(state_query: u8) -> ChainExtensionMethodApi {
	crate::v0::build_read_state(FOREIGN_FUNGIBLES, state_query)
}
