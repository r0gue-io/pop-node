...
pub mod api {
	...
	pub type Event = runtime_types::paseo_runtime::RuntimeEvent;
	#[doc = r" The outer extrinsic enum."]
	pub type Call = runtime_types::paseo_runtime::RuntimeCall;
	#[doc = r" The outer error enum representing the DispatchError's Module variant."]
	pub type Error = runtime_types::paseo_runtime::RuntimeError;
	...
	pub fn is_codegen_valid_for(metadata: &::subxt::Metadata) -> bool {
		...
		runtime_metadata_hash
			== [
				82u8, 104u8, 44u8, 240u8, 121u8, 224u8, 140u8, 145u8, 17u8, 39u8, 7u8, 69u8, 27u8,
				213u8, 213u8, 74u8, 128u8, 149u8, 138u8, 190u8, 113u8, 2u8, 184u8, 74u8, 59u8,
				106u8, 239u8, 75u8, 247u8, 199u8, 233u8, 255u8,
			]
	}
	pub mod system {
		use super::root_mod;
				...
				pub mod events {
					...
					pub type Events = ::std::vec::Vec<
						runtime_types::frame_system::EventRecord<
							runtime_types::paseo_runtime::RuntimeEvent,
							::subxt::utils::H256,
						>,
					>;
				}
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::Address::new_static(
						...
						vec![],
						[
							107u8, 163u8, 65u8, 9u8, 20u8, 243u8, 12u8, 101u8, 236u8, 227u8, 156u8,
							4u8, 100u8, 169u8, 81u8, 226u8, 113u8, 107u8, 67u8, 117u8, 32u8, 217u8,
							168u8, 33u8, 94u8, 244u8, 63u8, 91u8, 72u8, 85u8, 72u8, 78u8,
						],
					)
				}
			...
			pub mod types {
				...
				pub mod holds {
					...
					pub type Holds = runtime_types::bounded_collections::bounded_vec::BoundedVec<
						runtime_types::pallet_balances::types::IdAmount<
							runtime_types::paseo_runtime::RuntimeHoldReason,
							::core::primitive::u128,
						>,
					>;
					pub type Param0 = ::subxt::utils::AccountId32;
				...
				pub mod freezes {
					...
					pub type Freezes = runtime_types::bounded_collections::bounded_vec::BoundedVec<
						runtime_types::pallet_balances::types::IdAmount<
							runtime_types::paseo_runtime::RuntimeFreezeReason,
							::core::primitive::u128,
						>,
					>;
					pub type Param0 = ::subxt::utils::AccountId32;
	...
	pub mod utility {
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub mod batch {
					use super::runtime_types;
					pub type Calls = ::std::vec::Vec<runtime_types::paseo_runtime::RuntimeCall>;
				}
				...
				pub mod dispatch_as {
					use super::runtime_types;
					pub type AsOrigin = runtime_types::paseo_runtime::OriginCaller;
					pub type Call = runtime_types::paseo_runtime::RuntimeCall;
				}
			...
			impl TransactionApi {
				...
				pub fn batch(
					...
					::subxt::tx::Payload::new_static(
						...
						types::Batch { calls },
						[
							112u8, 138u8, 4u8, 242u8, 203u8, 225u8, 45u8, 176u8, 52u8, 216u8, 57u8,
							3u8, 127u8, 20u8, 5u8, 194u8, 52u8, 229u8, 48u8, 77u8, 165u8, 234u8,
							208u8, 227u8, 10u8, 20u8, 42u8, 216u8, 80u8, 112u8, 173u8, 5u8,
						],
					)
				}
				#[doc = "See [`Pallet::as_derivative`]."]
				pub fn as_derivative(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							253u8, 72u8, 157u8, 136u8, 244u8, 115u8, 46u8, 195u8, 132u8, 77u8,
							195u8, 25u8, 220u8, 86u8, 233u8, 143u8, 6u8, 161u8, 109u8, 250u8,
							149u8, 37u8, 153u8, 148u8, 44u8, 60u8, 113u8, 207u8, 24u8, 117u8,
							106u8, 229u8,
						],
					)
				}
				...
				pub fn batch_all(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							208u8, 26u8, 10u8, 29u8, 101u8, 108u8, 117u8, 90u8, 25u8, 158u8, 105u8,
							199u8, 41u8, 174u8, 22u8, 73u8, 34u8, 238u8, 83u8, 130u8, 162u8, 22u8,
							67u8, 167u8, 196u8, 13u8, 14u8, 255u8, 107u8, 58u8, 28u8, 63u8,
						],
					)
				}
				#[doc = "See [`Pallet::dispatch_as`]."]
				pub fn dispatch_as(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							89u8, 68u8, 74u8, 37u8, 99u8, 190u8, 199u8, 6u8, 102u8, 82u8, 67u8,
							105u8, 63u8, 16u8, 110u8, 228u8, 27u8, 252u8, 236u8, 63u8, 185u8, 10u8,
							181u8, 92u8, 255u8, 60u8, 168u8, 126u8, 213u8, 88u8, 70u8, 251u8,
						],
					)
				}
				#[doc = "See [`Pallet::force_batch`]."]
				pub fn force_batch(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							171u8, 58u8, 237u8, 122u8, 255u8, 161u8, 96u8, 211u8, 58u8, 110u8,
							213u8, 179u8, 146u8, 162u8, 17u8, 29u8, 208u8, 252u8, 191u8, 230u8,
							198u8, 229u8, 41u8, 216u8, 238u8, 125u8, 122u8, 63u8, 38u8, 70u8,
							182u8, 73u8,
						],
					)
				}
				...
				pub fn with_weight(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							222u8, 11u8, 33u8, 114u8, 207u8, 181u8, 147u8, 37u8, 153u8, 51u8, 6u8,
							162u8, 201u8, 76u8, 191u8, 234u8, 100u8, 252u8, 109u8, 128u8, 29u8,
							221u8, 187u8, 198u8, 193u8, 36u8, 17u8, 238u8, 176u8, 138u8, 89u8,
							248u8,
						],
					)
				}
			...
			impl TransactionApi {
				...
				pub fn send(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							74u8, 58u8, 223u8, 198u8, 121u8, 124u8, 154u8, 196u8, 19u8, 164u8,
							46u8, 154u8, 198u8, 240u8, 196u8, 206u8, 190u8, 136u8, 30u8, 130u8,
							219u8, 137u8, 84u8, 102u8, 211u8, 43u8, 148u8, 100u8, 153u8, 249u8,
							177u8, 236u8,
						],
					)
				}
				...
				pub fn execute(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							79u8, 189u8, 51u8, 142u8, 112u8, 47u8, 41u8, 185u8, 207u8, 237u8,
							189u8, 162u8, 110u8, 145u8, 11u8, 241u8, 82u8, 10u8, 110u8, 103u8,
							141u8, 186u8, 234u8, 198u8, 172u8, 190u8, 17u8, 247u8, 123u8, 140u8,
							58u8, 217u8,
						],
					)
				}
			...
			impl TransactionApi {
				...
				pub fn sudo(&self, call: types::sudo::Call) -> ::subxt::tx::Payload<types::Sudo> {
					::subxt::tx::Payload::new_static(
						...
						[
							198u8, 133u8, 177u8, 30u8, 126u8, 91u8, 17u8, 57u8, 96u8, 62u8, 134u8,
							114u8, 78u8, 43u8, 143u8, 108u8, 243u8, 82u8, 230u8, 231u8, 3u8, 73u8,
							188u8, 254u8, 106u8, 195u8, 46u8, 82u8, 223u8, 232u8, 40u8, 172u8,
						],
					)
				}
				#[doc = "See [`Pallet::sudo_unchecked_weight`]."]
				pub fn sudo_unchecked_weight(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							23u8, 147u8, 60u8, 215u8, 4u8, 117u8, 126u8, 183u8, 155u8, 32u8, 185u8,
							86u8, 9u8, 3u8, 32u8, 217u8, 189u8, 255u8, 85u8, 162u8, 208u8, 67u8,
							238u8, 199u8, 37u8, 212u8, 15u8, 137u8, 168u8, 121u8, 62u8, 217u8,
						],
					)
				}
				#[doc = "See [`Pallet::set_key`]."]
				...
				pub fn sudo_as(
					...
					::subxt::tx::Payload::new_static(
						...
						[
							68u8, 11u8, 47u8, 100u8, 133u8, 182u8, 102u8, 20u8, 123u8, 198u8,
							243u8, 91u8, 185u8, 123u8, 160u8, 181u8, 126u8, 19u8, 92u8, 12u8, 26u8,
							118u8, 81u8, 193u8, 91u8, 204u8, 155u8, 70u8, 128u8, 192u8, 165u8,
							49u8,
						],
					)
				}
	...
	pub mod runtime_types {
		...
		pub mod pallet_utility {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[doc = "See [`Pallet::dispatch_as`]."]
					dispatch_as {
						as_origin: ::std::boxed::Box<runtime_types::paseo_runtime::OriginCaller>,
						call: ::std::boxed::Box<::core::primitive::bool>,
					},
					#[codec(index = 4)]
					#[doc = "See [`Pallet::force_batch`]."]
		...
		pub mod paseo_runtime {
			...
			pub enum OriginCaller {
				# [codec (index = 0)] system (runtime_types :: frame_support :: dispatch :: RawOrigin < :: subxt :: utils :: AccountId32 > ,) , # [codec (index = 22)] Origins (runtime_types :: paseo_runtime :: governance :: origins :: pallet_custom_origins :: Origin ,) , # [codec (index = 50)] ParachainsOrigin (runtime_types :: polkadot_runtime_parachains :: origin :: pallet :: Origin ,) , # [codec (index = 99)] XcmPallet (runtime_types :: pallet_xcm :: pallet :: Origin ,) , # [codec (index = 4)] Void (runtime_types :: sp_core :: Void ,) , }
			#[derive(
				:: subxt :: ext :: codec :: Decode,
				:: subxt :: ext :: codec :: Encode,
				:: subxt :: ext :: scale_decode :: DecodeAsType,
