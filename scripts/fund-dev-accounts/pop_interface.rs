...
pub mod api {
	...
	pub static PALLETS: [&str; 1usize] = ["System"];
	pub static RUNTIME_APIS: [&str; 0usize] = [];
	#[doc = r" The error type returned when there is a runtime issue."]
	pub type DispatchError = runtime_types::sp_runtime::DispatchError;
	#[doc = r" The outer event enum."]
	pub type Event = runtime_types::pop_runtime_devnet::RuntimeEvent;
	#[doc = r" The outer extrinsic enum."]
	pub type Call = runtime_types::pop_runtime_devnet::RuntimeCall;
	#[doc = r" The outer error enum representing the DispatchError's Module variant."]
	pub type Error = runtime_types::pop_runtime_devnet::RuntimeError;
				...
				pub mod events {
					...
					pub type Events = ::std::vec::Vec<
						runtime_types::frame_system::EventRecord<
							runtime_types::pop_runtime_devnet::RuntimeEvent,
							::subxt::utils::H256,
						>,
					>;
				}
